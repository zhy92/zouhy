'use strict';
page.ctrl('expireTaskDistribute', [], function($scope) {
	...
	* 加载页面模板
	*/
	render.$console.load(router.template('expire-task-distribute'), function() {
		$scope.def.listTmpl = render.$console.find('#expireTaskDistributeTmpl').html();
		$scope.$el = {
			$tbl: $console.find('#expireTaskDistributeTable'),
